...
import { handleListUsers, handleSaveUser, handleDeleteUser, handleListHierarchies, handleSaveHierarchy } from "./routes/admin.js";
// Import Notifications handlers
import { handleGetNotifications, handleMarkRead, handleMarkAllRead, handleDeleteNotification } from "./routes/notification.js";
// Import Tickets handlers
import { handleGetTickets, handleCreateTicket, handleAddComment, handleCloseTicket, handleReopenTicket, handleToggleFollowup } from "./routes/ticket.js";
...
import { handleGetMisDashboard, handleGetAssetsInventory, handleGetAssetsFilters, handleGetAssetsStats } from "./routes/reports.js";
...
// --- Approval Endpoints (Requires Auth) ---
...
router.post("/api/notifications/read-all", handleMarkAllRead, true);
router.delete("/api/notifications/:id", handleDeleteNotification, true);

// --- Tickets Endpoints (Requires Auth) ---
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // Centralized CORS injection: wrap response and inject Access-Control-Allow-Origin headers
