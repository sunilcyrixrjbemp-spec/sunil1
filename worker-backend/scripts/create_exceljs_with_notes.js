...
async function main() {
  ...
  const paths = [
    "C:/Users/Cyrix HealthCare/Desktop/Consolidated_Report_July_2026_ShortRemarks.xlsx",
    "C:/Users/Cyrix HealthCare/Desktop/Consolidated_Report_July_2026.xlsx",
    "C:/Users/Cyrix HealthCare/Desktop/Consolidated_Report_July_2026_ShortRemarks_V2.xlsx",
    "C:/Users/Cyrix HealthCare/Desktop/Consolidated_Report_July_2026_CellNotes.xlsx",
    path.resolve(__dirname, '../../Consolidated_Report_July_2026_ShortRemarks.xlsx'),
    path.resolve(__dirname, '../../Consolidated_Report_July_2026_NEW.xlsx')
  ];

  for (const p of paths) {
    try {
      await wb.xlsx.writeFile(p);
      console.log(`✅ Written ExcelJS workbook to: ${p}`);
    } catch (e) {
